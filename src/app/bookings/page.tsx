...
const FLIGHTS = [
  ...
  { who:'Robin', route:'SEA→FCA', date:'Fri 5/29', best:'AS 2402 1:13pm→3:34pm 2h21m', alts:'BOOKED (from TripIt). Robin booked separately.', card:'Robin booked' },
  { who:'C+R', route:'FCA→SEA', date:'Sun 5/31', best:'AS 2419 5:40pm→6:12pm 1h32m FIRST CLASS', alts:'BOOKED Colin: Chase #1016667852 conf ZAAGXY $218.40. Robin on same flight.', card:'Chase 1.5x boost' },
