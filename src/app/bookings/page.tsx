...
const STAYS = [
  ...
  { id:'gc', loc:'Grand Canyon', region:'South Rim, AZ', dates:'Mon-Wed 5/11-13', nights:2, dayNums:[2,3], status:'booked' as const,
    ...
    search:null },
  { id:'page', loc:'Page', region:'AZ', dates:'Wed-Fri 5/13-15', nights:3, dayNums:[4,5,6], status:'pending' as const, booking:null,
    ...
    search:{ ci:'Wed 5/13', co:'Sat 5/16', g:'2 adults',
      must:['2BR preferred (1 work day)','WiFi 300Mbps+ (May 15 = FULL WORK DAY)','Central Page (10-15min attractions)'],
      nice:['Kitchen','Desk','Free breakfast'],
      links:[{l:'Airbnb 2BR',u:'https://www.airbnb.com/s/Page--AZ/homes?checkin=2026-05-13&checkout=2026-05-16&adults=2&min_bedrooms=2'},{l:'VRBO',u:'https://www.vrbo.com/search?destination=Page%2C+AZ&startDate=2026-05-13&endDate=2026-05-16&adults=2'},{l:'Hotels.com',u:'https://www.hotels.com/Hotel-Search?destination=Page%2C+AZ&startDate=2026-05-13&endDate=2026-05-16&rooms=1&adults=2'},{l:'Booking.com',u:'https://www.booking.com/searchresults.html?ss=Page%2C+Arizona&checkin=2026-05-13&checkout=2026-05-16&group_adults=2&no_rooms=1'}],
      wifi:'Page is rural. Search for "fiber"/"Starlink".', avoid:null, budget:'$270-750 / 3n' }},
  { id:'moab', loc:'Moab', region:'UT', dates:'Sat-Tue 5/16-19', nights:4, dayNums:[7,8,9,10], status:'pending' as const, booking:null, acts:[],
    search:{ ci:'Sat 5/16', co:'Wed 5/20', g:'2 adults',
      must:['2BR REQUIRED (2+ work days, need door)','WiFi 300Mbps+ (2 work days video calls)','Central Moab (5mi Arches, 32mi Canyonlands)'],
      nice:['Desk/workspace','Kitchen','Pool for Mom'],
      links:[{l:'Airbnb 2BR',u:'https://www.airbnb.com/s/Moab--UT/homes?checkin=2026-05-16&checkout=2026-05-20&adults=2&min_bedrooms=2'},{l:'VRBO 2BR',u:'https://www.vrbo.com/search?destination=Moab%2C+UT&startDate=2026-05-16&endDate=2026-05-20&adults=2'},{l:'Hotels.com',u:'https://www.hotels.com/Hotel-Search?destination=Moab%2C+UT&startDate=2026-05-16&endDate=2026-05-20&rooms=1&adults=2'},{l:'Booking.com',u:'https://www.booking.com/searchresults.html?ss=Moab%2C+Utah&checkin=2026-05-16&checkout=2026-05-20&group_adults=2&no_rooms=1'}],
  ...
  { id:'slc', loc:'Salt Lake City', region:'UT', dates:'Wed-Sun 5/20-24', nights:4, dayNums:[11,12,13,14], status:'booked' as const,
    ...
    acts:[], search:null },
  { id:'driggs', loc:'Driggs', region:'Teton Valley, ID', dates:'Sun-Tue 5/24-26', nights:3, dayNums:[15,16,17], status:'pending' as const, booking:null, acts:[],
    search:{ ci:'Sun 5/24', co:'Wed 5/27', g:'2 adults',
      must:['2BR preferred (1.5 work days)','WiFi 300Mbps+ (Memorial Day = FULL WORK)','Driggs/Victor/Tetonia area'],
      nice:['Teton views','Kitchen','Desk','Pool/spa'],
      links:[{l:'Airbnb 2BR',u:'https://www.airbnb.com/s/Driggs--ID/homes?checkin=2026-05-24&checkout=2026-05-27&adults=2&min_bedrooms=2'},{l:'VRBO',u:'https://www.vrbo.com/search?destination=Driggs%2C+ID&startDate=2026-05-24&endDate=2026-05-27&adults=2'},{l:'Booking.com',u:'https://www.booking.com/searchresults.html?ss=Driggs%2C+Idaho&checkin=2026-05-24&checkout=2026-05-27&group_adults=2&no_rooms=1'}],
      wifi:'Silver Star fiber up to 1Gbps in valley. Ask hosts.', avoid:null, budget:'$450-1800 / 3n' }},
  { id:'yellowstone', loc:'West Yellowstone', region:'MT', dates:'Wed-Thu 5/27-28', nights:2, dayNums:[18,19], status:'pending' as const, booking:null, acts:[],
