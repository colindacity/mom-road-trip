...
const SCHEDULE: DaySchedule[] = [
  ...
  { n:18, date:'Wed May 27', title:'Victor → West Yellowstone (BAG DROP) → Old Faithful + Grand Prismatic', vibe:'Drive / Park · Light drizzle · 95mi/2h direct via Targhee Pass',
    hotel:'Crosswinds Inn, 201 Firehole Ave',
    bullets:[
      '09:00 Pack up Victor cabin (strip beds, trash, door code), check out 10am',
      '10:00 Drive Victor → ID-33 → Ashton → US-20 → Targhee Pass → West Yellowstone (2hr direct)',
      '12:30 Crosswinds Inn BAG DROP — lobby/storage, keep day bag (called Tue to arrange)',
      '13:00 Quick lunch — Wild West Pizza or Slippery Otter walk-in',
      '13:30 Enter Yellowstone West Entrance (5 min from hotel)',
      '14:00 Madison Junction (wildlife in meadows)',
      '14:30 Old Faithful — eruption + Inn lobby (use GeyserTimes app for next eruption)',
      '16:00 Grand Prismatic via Fairy Falls Trailhead overlook (1.6mi RT, 105ft) — mom-bail at 0.5mi if too much',
      '17:15 Return to Crosswinds Inn — REAL check-in, key pickup',
      '18:30 Dinner Wild West Pizza / Bullwinkle\'s / Madison Crossing',
    ],
    eats:'Cabin coffee. Quick West Yellowstone lunch. Wild West Pizza dinner',
    dontMiss:'BAG DROP FIRST — call Crosswinds Tue evening to arrange noon arrival before official 4pm check-in. Skip Teton Pass + south entrance — Tetons done Mon.',
    momNote:'Targhee Pass 7,072ft paved no concerns. Light drizzle 47% — rain shell. Mom-bail to Midway Geyser Basin (0.8mi flat) if Fairy Falls 105ft gain too much.' },
