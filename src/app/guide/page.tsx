...
const SCHEDULE: DaySchedule[] = [
  ...
  { n:18, date:'Wed May 27', title:'Victor → West Yellowstone (check in first) → evening Old Faithful + Grand Prismatic', vibe:'Drive / Park · Light drizzle · scenic 4h with stops',
    ...
    bullets:[
      ...
      '17:00 Old Faithful eruption + Inn lobby (evenings are far less crowded)',
      '18:45 Grand Prismatic via Fairy Falls overlook (best evening light, less steam)',
      '20:00 Back to town for dinner, sunset 8:58pm',
    ],
