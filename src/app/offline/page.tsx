...
const ROUTES: { dayNum: number; date: string; label: string; url: string; note: string }[] = [
  ...
  { dayNum: 18, date: 'Wed May 27', label: 'Victor → West Yellowstone (check in first) → evening Old Faithful + Grand Prismatic',
    url: 'https://www.google.com/maps/dir/Victor+ID/Upper+Mesa+Falls+ID/Harriman+State+Park+Island+Park+ID/Crosswinds+Inn+201+Firehole+Ave+West+Yellowstone+MT/Old+Faithful+Yellowstone/Fairy+Falls+Trailhead+Yellowstone/Crosswinds+Inn+West+Yellowstone+MT/',
    note: 'Mesa Falls · Harriman/Island Park · check in 4pm · evening Old Faithful · Fairy Falls overlook' },
