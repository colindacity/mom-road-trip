  ...
  days: [
    ...
    // ============================================================
    {
      ...
      activities: [
        ...
        {
          id: 'a18-2',
          name: 'Direct Drive Victor to West Yellowstone (no walk-away stops)',
          description: 'Drive straight there: ID-33 north to Ashton, then US-20 north over Targhee Pass to West Yellowstone. About 2 hours. Because the car is full of luggage you do not want to leave it for walks today, so this is a drive-only morning. Any scenic look (Henrys Lake, the Island Park reservoir) is a quick pull-over where you stay right by the car. Goal: reach Crosswinds by about 12:30pm and offload the bags so the rest of the day is free.',
          startTime: '10:00 AM',
          endTime: '12:30 PM',
          duration: '2h 30m',
          difficulty: 'easy',
          seniorFriendly: true,
          reservationRequired: false,
          directionsUrl: 'https://www.google.com/maps/dir/Victor+ID/Crosswinds+Inn+201+Firehole+Ave+West+Yellowstone+MT/',
          tips: ['Drive-only morning: do not leave the loaded car at trailheads (theft + bears smell food)', 'Quick stay-by-the-car pull-overs only: Henrys Lake, Island Park reservoir', 'Fill gas in Ashton or Island Park, West Yellowstone gas is pricey', 'Upper Mesa Falls already done on the way in']
        },
        {
          id: 'a18-3',
          name: 'Drop ALL Bags at Crosswinds Inn (call ahead to hold)',
          description: 'Arrive Crosswinds Inn around 12:30pm and offload every bag, plus any cooler or food, even if the room is not ready yet. Hotels hold luggage behind the desk before check-in. This empties the car so you can walk freely the rest of the day with nothing to steal and no food to draw bears. Pick up the room key later at the 4pm check-in.',
          startTime: '12:30 PM',
          endTime: '1:00 PM',
          duration: '30 min',
          difficulty: 'easy',
          seniorFriendly: true,
          reservationRequired: false,
          tips: ['📞 Call Crosswinds 406-646-9557 this morning: "We arrive ~12:30pm, can you hold our bags before the 4pm check-in?" They almost always can', '201 Firehole Ave, West Yellowstone. Conf #5288855262 PIN 3523', 'Take everything scented out of the car, including snacks and cooler', 'If for any reason they cannot hold bags: keep the car parked on Canyon St in town where you can see it, and do town things until 4pm']
        },
        {
          id: 'a18-4',
          name: 'Lunch in West Yellowstone (car empty, walk freely)',
          description: 'With the bags dropped, grab a relaxed lunch in town and stretch. The car is empty now so you can walk wherever. Then head into the park for the afternoon and evening.',
          startTime: '1:00 PM',
          endTime: '2:00 PM',
          duration: '1 hour',
          difficulty: 'easy',
          seniorFriendly: true,
          reservationRequired: false,
          tips: ['Lunch: Wild West Pizza, Slippery Otter Pub, or Cafe Madriz', 'Grizzly and Wolf Discovery Center is a nice indoor hour if you want it', 'West entrance is 5 min from town']
        },
        {
          id: 'a18-5',
          name: 'Old Faithful (afternoon)',
          description: 'Drive in to Old Faithful. Flat 0.7mi accessible boardwalk loop with benches every 100ft or so. Eruptions run about every 94 minutes. The Old Faithful Inn lobby (largest log structure in the world) is worth a look while you wait. With bags already at the hotel you can take your time.',
          startTime: '2:30 PM',
          endTime: '4:30 PM',
          duration: '2 hours',
          difficulty: 'easy',
          ...
          tips: ['Use the GeyserTimes app for the next predicted eruption', 'Old Faithful Inn lobby: huge 1904 log structure, worth a walk through', 'Parking lots here are patrolled and busy, fine for the now-empty car', 'Restrooms + snacks at the visitor center']
        },
        {
          id: 'a18-6',
          name: 'Grand Prismatic from Fairy Falls Overlook (best late-day light)',
          description: 'The famous rainbow hot spring, seen from above at the Fairy Falls overlook. 1.6mi round trip with a gentle 105ft climb. Late afternoon is the best time: less steam, softer light, smaller crowds. Mom can turn back at the 0.5mi mark for a partial view if the climb is too much, or do the flat Midway Geyser Basin boardwalk instead. Bags are already at the hotel, so the trailhead lot is fine.',
          startTime: '5:00 PM',
          endTime: '6:30 PM',
          duration: '1h 30m',
          difficulty: 'easy',
          ...
          tips: ['Trailhead is Fairy Falls, NOT the Grand Prismatic parking lot', 'Late afternoon means less steam and the lot has cleared out', 'Mom can turn back at 0.5mi for a tree-framed view', 'Flat backup: Midway Geyser Basin boardwalk (0.8mi), walks right past the spring at ground level', 'Sunset is 8:58pm, plenty of light']
        },
        {
          id: 'a18-7',
          name: 'Pick Up Room Key + Dinner in West Yellowstone',
          description: 'Drive back via Madison Junction (elk and bison in the meadows in the evening). Pick up the room key at Crosswinds if you have not already, settle the bags into the room, then dinner in town. Early to bed: tomorrow is a 5am start for Lamar Valley wildlife.',
          startTime: '6:45 PM',
          endTime: '8:30 PM',
          duration: '1h 45m',
          difficulty: 'easy',
      ...
      notes: ['DROP BAGS FIRST. Drive direct to Crosswinds (~12:30pm), offload every bag + cooler at the desk even before the room is ready. That empties the car so you can walk freely all day with nothing to steal and no food to draw bears.', '📞 Call Crosswinds 406-646-9557 this morning to confirm they will hold bags before 4pm check-in (they almost always do).', 'Drive-only morning: no trailhead stops with the loaded car. Quick stay-by-the-car pull-overs only.', 'After bag drop: lunch in town, then Old Faithful + Grand Prismatic in the afternoon. Sunset 8:58pm.', 'Upper Mesa Falls already done on the way in.'],
      budgetBreakdown: { accommodation: 292, food: 70, activities: 35, gas: 30, total: 427 },
      momNotes: {
        vibes: ['drive', 'mountain'], energy: 2,
        blurb: 'Drive straight to West Yellowstone, drop all the bags at the hotel, then a free afternoon at Old Faithful and Grand Prismatic.',
        tip: 'Drop bags at Crosswinds first (call 406-646-9557 to confirm they will hold them) so the car is empty and safe for walks. Grand Prismatic from the Fairy Falls overlook (1.6mi round trip, 105ft) is best in late-day light. Mom can turn back at 0.5mi, or do the flat Midway boardwalk (0.8mi). Old Faithful erupts about every 94 minutes, use the GeyserTimes app.'
      }
    },
